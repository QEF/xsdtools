...
MODULE qes_init_module
  ...
  !
  !
  SUBROUTINE qes_init_atomic_structure(obj, tagname, nat, alat, bravais_index, cell, atomic_positions,&
  ...
  SUBROUTINE qes_init_electron_control(obj, tagname, diagonalization, mixing_mode, mixing_beta,&
                                      ...
                                      tbeta_smoothing, diago_thr_init, diago_full_acc, diago_cg_maxiter, diago_david_ndim &
                                      )
    !
    IMPLICIT NONE
    !
